...
TEST_CASE("move_only_function free function", "[move_only_function]") { test_free_function<p2548::move_only_function>(); }
TEST_CASE("copyable_function free function", "[copyable_function]") { test_free_function<p2548::copyable_function>(); }

TEST_CASE("move_only_function free function ptr", "[move_only_function]") { test_free_function_ptr<p2548::move_only_function>(); }
TEST_CASE("copyable_function free function ptr", "[copyable_function]") { test_free_function_ptr<p2548::copyable_function>(); }

TEST_CASE("move_only_function member function ptr", "[move_only_function]") { test_member_function_ptr<p2548::move_only_function>(); }
TEST_CASE("copyable_function member function ptr", "[copyable_function]") { test_member_function_ptr<p2548::copyable_function>(); }
...
TEST_CASE("move_only_function moved-from state", "[move_only_function]") { test_moved_from_state<p2548::move_only_function>(); }
TEST_CASE("copyable_function moved-from state", "[copyable_function]") { test_moved_from_state<p2548::copyable_function>(); }
